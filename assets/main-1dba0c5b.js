import { C as je } from "./Cart-7c1cb072.js";
function me(e, t) {
  return function () {
...
const ht = (e) => {
  ...
  mt = A("AsyncFunction"),
  yt = (e) => e && (q(e) || S(e)) && S(e.then) && S(e.catch),
  a = {
    isArray: N,
    isArrayBuffer: ye,
    isBuffer: Ie,
  ...
  function c(l, h, b) {
    ...
    if (l && !b && typeof l == "object") {
      if (a.endsWith(h, "{}"))
        ...
        (a.isArray(l) && wt(l)) ||
        ((a.isFileList(l) || a.endsWith(h, "[]")) && (T = a.toArray(l)))
      )
        return (
          (h = ge(h)),
      ...
      p.push(l),
        a.forEach(l, function (T, R) {
          (!(a.isUndefined(T) || T === null) &&
            s.call(t, T, a.isString(R) ? R.trim() : R, h, E)) === !0 &&
            w(T, h ? h.concat(R) : [R]);
        }),
        p.pop();
    }
    ...
    return (
      ...
      f
        ...
        : ((!s[i] || !a.isObject(s[i])) && (s[i] = []),
          t(n, r, s[i], o) && a.isArray(s[i]) && (s[i] = Pt(s[i])),
          !u)
    );
  }
...
const It = O.isStandardBrowserEnv
  ? (function () {
      return {
  ...
  Vt =
    ...
    function (e) {
      return new Promise(function (n, r) {
        ...
        c.open(e.method.toUpperCase(), Ce(p, e.params, e.paramsSerializer), !0),
          (c.timeout = e.timeout);
        function E() {
          if (!c) return;
          const l = g.from(
        ...
        s === void 0 && o.setContentType(null),
          "setRequestHeader" in c &&
            a.forEach(o.toJSON(), function (h, b) {
...
const fe = (e) => `- ${e}`,
  Wt = (e) => a.isFunction(e) || e === null || e === !1,
  De = {
    getAdapter: (e) => {
      e = a.isArray(e) ? e : [e];
      const { length: t } = e;
      ...
      for (let o = 0; o < t; o++) {
        ...
        if (
          ((r = n),
          !Wt(n) && ((r = v[(i = String(n)).toLowerCase()]), r === void 0))
        )
...
const X = { assertOptions: Kt, validators: ne },
  x = X.validators;
class k {
  constructor(t) {
    (this.defaults = t),
...
y.mergeConfig = C;
y.AxiosHeaders = g;
y.formToJSON = (e) => Pe(a.isHTMLForm(e) ? new FormData(e) : e);
y.getAdapter = De.getAdapter;
y.HttpStatusCode = Qt;
y.default = y;
const Zt = y;
class Yt {
  constructor(t, n = "#cart") {
    (this.root = document.querySelector(t)),
      (this.cart = new je(n)),
      (this.cartIcon = document.querySelector(n));
  }
  async init() {
    ...
    t.map((r) => {
      ...
      return (
        (u.innerText = this.cart.isInCart(r.id)
          ? "В корзине"
          : "Добавить в корзину"),
        u.addEventListener("click", () => {
          this.cart.isInCart(r.id)
            ? (this.cart.deleteItem(r.id, r),
              (u.innerText = "Добавить в корзину"))
            : (this.cart.addItem(r.id, r), (u.innerText = "В корзине"));
        }),
        (o.innerText = r.title),
        (i.innerText = r.body),
        s.appendChild(o),
